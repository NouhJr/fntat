...
class UserOwnedPosts extends StatefulWidget {
  @override
  _UserOwnedPostsState createState() => _UserOwnedPostsState();
}

class _UserOwnedPostsState extends State<UserOwnedPosts> {
  var userName = '';
